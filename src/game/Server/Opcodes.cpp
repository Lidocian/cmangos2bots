...
OpcodeHandler opcodeTable[NUM_MSG_TYPES] =
{
    ...
    /*0x362*/ { "CMSG_LFG_PROPOSAL_RESPONSE",                   STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleLfgProposalResultOpcode },
    ...
    /*0x36E*/ { "CMSG_LFG_GET_PLAYER_INFO",                     STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::HandleLfgPlayerLockInfoRequestOpcode },
    /*0x36F*/ { "SMSG_LFG_PLAYER_INFO",                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               },
    /*0x370*/ { "CMSG_LFG_TELEPORT",                            STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::HandleLfgTeleportOpcode },
    /*0x371*/ { "CMSG_LFG_GET_PARTY_INFO",                      STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::HandleLfgPartyLockInfoRequestOpcode },
